<template>
    <div class="container">
        <div class="socials">
            <a href="https://www.linkedin.com/in/colin-lespilette/"><img src="/linkedin.svg" alt="LinkedIn"></a>
            <a href="https://github.com/Apalian"><img src="/github.svg" alt="Github"></a>
        </div>
        <a @click="copyEmail" class="email-link" title="Copier l'adresse email"><img src="/mail.svg" alt="Mail"></a>
